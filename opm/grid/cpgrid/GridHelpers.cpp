...
Vector faceCenterEcl(const Dune::CpGrid& grid, int cell_index, int face_tag, int faceIdxOnLeafGridView)
{
    ...
    // to agree with eclipse.
    return grid.faceCenterEcl(cell_index, face_tag, faceIdxOnLeafGridView);
}
